...
library ContractLib {
    ...
    error ErrorContractLibTargetNotRegistered(address target);
    error ErrorContractLibNftIdNotRegistered(NftId nftId);
    ...
    error ErrorContractLibContractVersionMismatch(NftId contractNftId, VersionPart expectedVersion, VersionPart actualVersion);
        ...
        )
    {
        ...
        if(componentVersion != requiredComponentVersion) {
            revert ErrorContractLibContractVersionMismatch(
                componentInfo.nftId,
        ...
        returns (IRegistry.ObjectInfo memory info)
    {
        ...
        if (info.nftId.eqz()) {
            revert ErrorContractLibTargetNotRegistered(target);
        }
    }
        ...
        returns (IRegistry.ObjectInfo memory info)
    {
        ...
        if (info.nftId.eqz()) {
            revert ErrorContractLibNftIdNotRegistered(objectNftId);
        }
    }
}