...
contract GifTest is GifDeployer {
        ...
        internal
    {
        ...
        staking = Staking(registry.getStakingAddress());
        stakingReader = staking.getStakingReader();
        dip = IERC20Metadata(tokenRegistry.getDipToken());
