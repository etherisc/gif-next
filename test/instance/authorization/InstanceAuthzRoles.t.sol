...
contract InstanceAuthzRolesTest is InstanceAuthzBaseTest {
    ...
    function test_instanceAuthzRolesSetup() public {
        ...
        // check initial roles
        assertEq(instanceAdmin.roles(), 21, "unexpected initial instance roles count (admin)");
        assertEq(instanceReader.roles(), 21, "unexpected initial instance roles count (reader)");
    }
