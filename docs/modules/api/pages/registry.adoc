...
==== `[.contract-item-name]#++completeSetup++#++(contract IRegistry registry, address gifAdmin, address gifManager)++` [.item-kind]#public#
...
==== `[.contract-item-name]#++isActive++#++(uint256 chainId, address token, VersionPart release) → bool++` [.item-kind]#external#
