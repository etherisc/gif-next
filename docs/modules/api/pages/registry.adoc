...
:ErrorRegistryAdminIsAlreadySetUp: pass:normal[xref:#RegistryAdmin-ErrorRegistryAdminIsAlreadySetUp--[`++ErrorRegistryAdminIsAlreadySetUp++`]]
...
:constructor: pass:normal[xref:#RegistryAdmin-constructor-address-[`++constructor++`]]
:completeSetup: pass:normal[xref:#RegistryAdmin-completeSetup-contract-IRegistry-address-address-[`++completeSetup++`]]
:authorizeService: pass:normal[xref:#RegistryAdmin-authorizeService-contract-IServiceAuthorization-contract-IService-[`++authorizeService++`]]
...
* [`++authorizeService(serviceAuthorization, service)++`]
...
[.contract-subindex-inherited]
.AccessAdmin
* [`++createRole(roleId, adminRoleId, name, maxMemberCount, memberRemovalDisabled)++`]
* [`++setRoleDisabled(roleId, disabled)++`]
* [`++grantRole(account, roleId)++`]
* [`++revokeRole(account, roleId)++`]
* [`++renounceRole(roleId)++`]
...
* [`++_createRole(roleId, adminRoleId, roleName, maxMemberCount, memberRemovalDisabled)++`]
* [`++_setRoleDisabled(roleId, disabled)++`]
* [`++_createTarget(target, targetName)++`]
* [`++_isContract(target)++`]
...
[.contract-subindex-inherited]
.IAccessAdmin
* [`++LogRoleCreated(roleId, roleAdminId, name)++`]
* [`++LogRoleDisabled(roleId, disabled, disabledAtOld)++`]
...
[.contract-item]
[[RegistryAdmin-constructor-address-]]
==== `[.contract-item-name]#++constructor++#++(address deployer)++` [.item-kind]#public#
...
[.contract-item]
[[RegistryAdmin-authorizeService-contract-IServiceAuthorization-contract-IService-]]
==== `[.contract-item-name]#++authorizeService++#++(contract IServiceAuthorization serviceAuthorization, contract IService service)++` [.item-kind]#external#
...
.Functions
--
* [`++constructor(admin, initialOwner)++`]
...
==== `[.contract-item-name]#++constructor++#++(contract RegistryAdmin admin, address initialOwner)++` [.item-kind]#public#
...
:LogReleaseCreation: pass:normal[xref:#ReleaseManager-LogReleaseCreation-VersionPart-bytes32-address-[`++LogReleaseCreation++`]]
...
:ErrorReleaseManagerVersionMismatch: pass:normal[xref:#ReleaseManager-ErrorReleaseManagerVersionMismatch-VersionPart-VersionPart-[`++ErrorReleaseManagerVersionMismatch++`]]
:ErrorReleaseManagerNoDomains: pass:normal[xref:#ReleaseManager-ErrorReleaseManagerNoDomains-VersionPart-[`++ErrorReleaseManagerNoDomains++`]]
...
:ErrorReleaseManagerServiceDomainMismatch: pass:normal[xref:#ReleaseManager-ErrorReleaseManagerServiceDomainMismatch-ObjectType-ObjectType-[`++ErrorReleaseManagerServiceDomainMismatch++`]]
...
:_releaseAccessManager: pass:normal[xref:#ReleaseManager-_releaseAccessManager-mapping-VersionPart----address-[`++_releaseAccessManager++`]]
...
:_serviceAuthorization: pass:normal[xref:#ReleaseManager-_serviceAuthorization-mapping-VersionPart----contract-IServiceAuthorization-[`++_serviceAuthorization++`]]
...
:_registeredServices: pass:normal[xref:#ReleaseManager-_registeredServices-uint256[`++_registeredServices++`]]
:_servicesToRegister: pass:normal[xref:#ReleaseManager-_servicesToRegister-uint256[`++_servicesToRegister++`]]
...
:prepareNextRelease: pass:normal[xref:#ReleaseManager-prepareNextRelease-contract-IServiceAuthorization-bytes32-[`++prepareNextRelease++`]]
...
.Events
--
* [`++LogReleaseCreation(version, salt, authority)++`]
...
[.contract-item]
[[ReleaseManager-prepareNextRelease-contract-IServiceAuthorization-bytes32-]]
==== `[.contract-item-name]#++prepareNextRelease++#++(contract IServiceAuthorization serviceAuthorization, bytes32 salt) → address authority, VersionPart version, bytes32 releaseSalt++` [.item-kind]#external#
...
[.contract-item]
[[ReleaseManager-LogReleaseCreation-VersionPart-bytes32-address-]]
==== `[.contract-item-name]#++LogReleaseCreation++#++(VersionPart version, bytes32 salt, address authority)++` [.item-kind]#event#
