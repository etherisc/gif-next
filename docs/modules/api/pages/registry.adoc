...
:LogRegistryServiceRegistered: pass:normal[xref:#IRegistry-LogRegistryServiceRegistered-NftId-VersionPart-ObjectType-[`++LogRegistryServiceRegistered++`]]
:LogRegistryChainRegistryRegistered: pass:normal[xref:#IRegistry-LogRegistryChainRegistryRegistered-NftId-ChainId-address-[`++LogRegistryChainRegistryRegistered++`]]
...
:ErrorRegistryNotOnMainnet: pass:normal[xref:#IRegistry-ErrorRegistryNotOnMainnet-ChainId-[`++ErrorRegistryNotOnMainnet++`]]
...
:ErrorRegistryChainRegistryAddressZero: pass:normal[xref:#IRegistry-ErrorRegistryChainRegistryAddressZero-NftId-ChainId-[`++ErrorRegistryChainRegistryAddressZero++`]]
:ErrorRegistryChainRegistryNftIdInvalid: pass:normal[xref:#IRegistry-ErrorRegistryChainRegistryNftIdInvalid-NftId-ChainId-[`++ErrorRegistryChainRegistryNftIdInvalid++`]]
:ErrorRegistryChainRegistryAlreadyRegistered: pass:normal[xref:#IRegistry-ErrorRegistryChainRegistryAlreadyRegistered-NftId-ChainId-[`++ErrorRegistryChainRegistryAlreadyRegistered++`]]
...
:registerRegistry: pass:normal[xref:#IRegistry-registerRegistry-NftId-ChainId-address-[`++registerRegistry++`]]
...
:getRegistryNftId: pass:normal[xref:#IRegistry-getRegistryNftId-ChainId-[`++getRegistryNftId++`]]
...
==== `[.contract-item-name]#++registerRegistry++#++(NftId nftId, ChainId chainId, address chainRegistryAddress)++` [.item-kind]#external#
...
==== `[.contract-item-name]#++getChainId++#++(uint256 idx) → ChainId++` [.item-kind]#external#

Returns the chain id at the specified index.

[.contract-item]
[[IRegistry-getRegistryNftId-ChainId-]]
==== `[.contract-item-name]#++getRegistryNftId++#++(ChainId chainId) → NftId nftId++` [.item-kind]#external#
...
==== `[.contract-item-name]#++LogRegistryObjectRegistered++#++(NftId indexed nftId, NftId indexed parentNftId, ObjectType indexed objectType, bool isInterceptor, address objectAddress, address initialOwner)++` [.item-kind]#event#

[.contract-item]
[[IRegistry-LogRegistryServiceRegistered-NftId-VersionPart-ObjectType-]]
==== `[.contract-item-name]#++LogRegistryServiceRegistered++#++(NftId indexed nftId, VersionPart indexed majorVersion, ObjectType indexed domain)++` [.item-kind]#event#

[.contract-item]
[[IRegistry-LogRegistryChainRegistryRegistered-NftId-ChainId-address-]]
==== `[.contract-item-name]#++LogRegistryChainRegistryRegistered++#++(NftId indexed nftId, ChainId indexed chainId, address indexed chainRegistryAddress)++` [.item-kind]#event#
...
:calculateTokenId: pass:normal[xref:#ChainNft-calculateTokenId-uint256-ChainId-[`++calculateTokenId++`]]
...
==== `[.contract-item-name]#++calculateTokenId++#++(uint256 idIndex, ChainId chainId) → uint256 id++` [.item-kind]#public#
...
==== `[.contract-item-name]#++LogTokenInterceptorAddress++#++(uint256 indexed tokenId, address indexed interceptor)++` [.item-kind]#event#
...
:registerRegistry: pass:normal[xref:#Registry-registerRegistry-NftId-ChainId-address-[`++registerRegistry++`]]
...
:getRegistryNftId: pass:normal[xref:#Registry-getRegistryNftId-ChainId-[`++getRegistryNftId++`]]
...
==== `[.contract-item-name]#++registerRegistry++#++(NftId nftId, ChainId chainId, address registryAddress)++` [.item-kind]#external#
...
==== `[.contract-item-name]#++getChainId++#++(uint256 idx) → ChainId++` [.item-kind]#public#

Returns the chain id at the specified index.

[.contract-item]
[[Registry-getRegistryNftId-ChainId-]]
==== `[.contract-item-name]#++getRegistryNftId++#++(ChainId chainId) → NftId nftId++` [.item-kind]#public#
...
:LogReleaseCreated: pass:normal[xref:#ReleaseRegistry-LogReleaseCreated-address-VersionPart-bytes32-[`++LogReleaseCreated++`]]
:LogReleaseActivated: pass:normal[xref:#ReleaseRegistry-LogReleaseActivated-VersionPart-[`++LogReleaseActivated++`]]
:LogReleaseEnabled: pass:normal[xref:#ReleaseRegistry-LogReleaseEnabled-VersionPart-bool-[`++LogReleaseEnabled++`]]
...
==== `[.contract-item-name]#++LogReleaseCreated++#++(address indexed releaseAdmin, VersionPart indexed release, bytes32 indexed salt)++` [.item-kind]#event#

[.contract-item]
[[ReleaseRegistry-LogReleaseActivated-VersionPart-]]
==== `[.contract-item-name]#++LogReleaseActivated++#++(VersionPart indexed release)++` [.item-kind]#event#

[.contract-item]
[[ReleaseRegistry-LogReleaseEnabled-VersionPart-bool-]]
==== `[.contract-item-name]#++LogReleaseEnabled++#++(VersionPart indexed release, bool indexed active)++` [.item-kind]#event#
...
==== `[.contract-item-name]#++LogTokenRegistryTokenRegistered++#++(ChainId indexed chainId, address indexed token, uint256 decimals, string symbol)++` [.item-kind]#event#

[.contract-item]
[[TokenRegistry-LogTokenRegistryTokenGlobalStateSet-ChainId-address-bool-]]
==== `[.contract-item-name]#++LogTokenRegistryTokenGlobalStateSet++#++(ChainId indexed chainId, address indexed token, bool indexed active)++` [.item-kind]#event#

[.contract-item]
[[TokenRegistry-LogTokenRegistryTokenStateSet-ChainId-address-VersionPart-bool-]]
==== `[.contract-item-name]#++LogTokenRegistryTokenStateSet++#++(ChainId indexed chainId, address indexed token, VersionPart indexed release, bool active)++` [.item-kind]#event#
