...
:__Oracle_init: pass:normal[xref:#Oracle-__Oracle_init-NftId-contract-IAuthorization-address-string-[`++__Oracle_init++`]]
...
[.contract-item]
[[Oracle-__Oracle_init-NftId-contract-IAuthorization-address-string-]]
==== `[.contract-item-name]#++__Oracle_init++#++(NftId productNftId, contract IAuthorization authorization, address initialOwner, string name)++` [.item-kind]#internal#
...
:_initializeBasicOracle: pass:normal[xref:#BasicOracle-_initializeBasicOracle-NftId-contract-IAuthorization-address-string-[`++_initializeBasicOracle++`]]
...
[.contract-item]
[[BasicOracle-_initializeBasicOracle-NftId-contract-IAuthorization-address-string-]]
==== `[.contract-item-name]#++_initializeBasicOracle++#++(NftId instanceNftId, contract IAuthorization authorization, address initialOwner, string name)++` [.item-kind]#internal#
...
:_checkRequestParams: pass:normal[xref:#OracleService-_checkRequestParams-Timestamp-string-[`++_checkRequestParams++`]]
...
[.contract-item]
[[OracleService-_checkRequestParams-Timestamp-string-]]
==== `[.contract-item-name]#++_checkRequestParams++#++(Timestamp expiryAt, string callbackMethodName)++` [.item-kind]#internal#
...
:constructor: pass:normal[xref:#OracleServiceManager-constructor-address-bytes32-[`++constructor++`]]
...
[.contract-item]
[[OracleServiceManager-constructor-address-bytes32-]]
