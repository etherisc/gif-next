...
:LogOracleRequestReceived: pass:normal[xref:#IOracleComponent-LogOracleRequestReceived-RequestId-NftId-[`++LogOracleRequestReceived++`]]
:LogOracleRequestCancelled: pass:normal[xref:#IOracleComponent-LogOracleRequestCancelled-RequestId-[`++LogOracleRequestCancelled++`]]
...
:activeRequests: pass:normal[xref:#IOracleComponent-activeRequests--[`++activeRequests++`]]
:getActiveRequest: pass:normal[xref:#IOracleComponent-getActiveRequest-uint256-[`++getActiveRequest++`]]
:isActiveRequest: pass:normal[xref:#IOracleComponent-isActiveRequest-RequestId-[`++isActiveRequest++`]]
...
==== `[.contract-item-name]#++activeRequests++#++() → uint256 numberOfRequests++` [.item-kind]#external#

[.contract-item]
[[IOracleComponent-getActiveRequest-uint256-]]
==== `[.contract-item-name]#++getActiveRequest++#++(uint256 idx) → RequestId requestId++` [.item-kind]#external#

[.contract-item]
[[IOracleComponent-isActiveRequest-RequestId-]]
==== `[.contract-item-name]#++isActiveRequest++#++(RequestId requestId) → bool isActive++` [.item-kind]#external#

[.contract-item]
[[IOracleComponent-LogOracleRequestReceived-RequestId-NftId-]]
==== `[.contract-item-name]#++LogOracleRequestReceived++#++(RequestId indexed requestId, NftId indexed requesterId)++` [.item-kind]#event#

[.contract-item]
[[IOracleComponent-LogOracleRequestCancelled-RequestId-]]
==== `[.contract-item-name]#++LogOracleRequestCancelled++#++(RequestId indexed requestId)++` [.item-kind]#event#
...
:activeRequests: pass:normal[xref:#Oracle-activeRequests--[`++activeRequests++`]]
:getActiveRequest: pass:normal[xref:#Oracle-getActiveRequest-uint256-[`++getActiveRequest++`]]
:isActiveRequest: pass:normal[xref:#Oracle-isActiveRequest-RequestId-[`++isActiveRequest++`]]
...
==== `[.contract-item-name]#++withdrawFees++#++(Amount) → Amount++` [.item-kind]#external#
...
==== `[.contract-item-name]#++_request++#++(RequestId requestId, NftId requesterId, bytes, Timestamp)++` [.item-kind]#internal#
