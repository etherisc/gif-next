...
:_initializeProduct: pass:normal[xref:#Product-_initializeProduct-address-NftId-string-address-struct-IComponents-ProductInfo-struct-IComponents-FeeInfo-contract-IAuthorization-address-bytes-[`++_initializeProduct++`]]
...
[.contract-item]
[[Product-_initializeProduct-address-NftId-string-address-struct-IComponents-ProductInfo-struct-IComponents-FeeInfo-contract-IAuthorization-address-bytes-]]
==== `[.contract-item-name]#++_initializeProduct++#++(address registry, NftId instanceNftId, string name, address token, struct IComponents.ProductInfo productInfo, struct IComponents.FeeInfo feeInfo, contract IAuthorization authorization, address initialOwner, bytes componentData)++` [.item-kind]#internal#
...
:_initializeBasicProduct: pass:normal[xref:#BasicProduct-_initializeBasicProduct-address-NftId-string-address-struct-IComponents-ProductInfo-struct-IComponents-FeeInfo-contract-IAuthorization-address-[`++_initializeBasicProduct++`]]
...
[.contract-item]
[[BasicProduct-_initializeBasicProduct-address-NftId-string-address-struct-IComponents-ProductInfo-struct-IComponents-FeeInfo-contract-IAuthorization-address-]]
==== `[.contract-item-name]#++_initializeBasicProduct++#++(address registry, NftId instanceNftId, string name, address token, struct IComponents.ProductInfo productInfo, struct IComponents.FeeInfo feeInfo, contract IAuthorization authorization, address initialOwner)++` [.item-kind]#internal#
...
:_getAndVerifyActiveComponent: pass:normal[xref:#ClaimService-_getAndVerifyActiveComponent-ObjectType-[`++_getAndVerifyActiveComponent++`]]
...
[.contract-item]
[[ClaimService-_getAndVerifyActiveComponent-ObjectType-]]
==== `[.contract-item-name]#++_getAndVerifyActiveComponent++#++(ObjectType expectedType) → NftId productNftId, contract IInstance instance++` [.item-kind]#internal#
