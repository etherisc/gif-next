...
:ErrorVersionTooBig: pass:normal[xref:#ObjectTypeLib-ErrorVersionTooBig-uint256-[`++ErrorVersionTooBig++`]]
...
:toVersionedName: pass:normal[xref:#ObjectTypeLib-toVersionedName-string-string-uint256-[`++toVersionedName++`]]
:maxNumReleases: pass:normal[xref:#ObjectTypeLib-maxNumReleases--[`++maxNumReleases++`]]
...
* [`++ne(a, b)++`]
* [`++toName(objectType)++`]
* [`++toVersionedName(name, suffix, version)++`]
* [`++maxNumReleases()++`]
* [`++toString(value)++`]
...
[.contract-item]
[[ObjectTypeLib-toVersionedName-string-string-uint256-]]
==== `[.contract-item-name]#++toVersionedName++#++(string name, string suffix, uint256 version) → string versionedName++` [.item-kind]#external#

[.contract-item]
[[ObjectTypeLib-maxNumReleases--]]
==== `[.contract-item-name]#++maxNumReleases++#++() → uint8++` [.item-kind]#public#

returns the max number of releases (major versions) this gif setup can handle.
...
:ALL_VERSIONS: pass:normal[xref:#RoleIdLib-ALL_VERSIONS-uint64[`++ALL_VERSIONS++`]]
:SERVICE_DOMAIN_ROLE_FACTOR: pass:normal[xref:#RoleIdLib-SERVICE_DOMAIN_ROLE_FACTOR-uint64[`++SERVICE_DOMAIN_ROLE_FACTOR++`]]
:COMPONENT_ROLE_FACTOR: pass:normal[xref:#RoleIdLib-COMPONENT_ROLE_FACTOR-uint64[`++COMPONENT_ROLE_FACTOR++`]]
:CUSTOM_ROLE_MIN: pass:normal[xref:#RoleIdLib-CUSTOM_ROLE_MIN-uint64[`++CUSTOM_ROLE_MIN++`]]
:zero: pass:normal[xref:#RoleIdLib-zero--[`++zero++`]]
:toRoleId: pass:normal[xref:#RoleIdLib-toRoleId-uint64-[`++toRoleId++`]]
:toComponentRoleId: pass:normal[xref:#RoleIdLib-toComponentRoleId-ObjectType-uint64-[`++toComponentRoleId++`]]
:toCustomRoleId: pass:normal[xref:#RoleIdLib-toCustomRoleId-uint64-[`++toCustomRoleId++`]]
:toInt: pass:normal[xref:#RoleIdLib-toInt-RoleId-[`++toInt++`]]
:roleForType: pass:normal[xref:#RoleIdLib-roleForType-ObjectType-[`++roleForType++`]]
:roleForTypeAndVersion: pass:normal[xref:#RoleIdLib-roleForTypeAndVersion-ObjectType-VersionPart-[`++roleForTypeAndVersion++`]]
:roleForTypeAndAllVersions: pass:normal[xref:#RoleIdLib-roleForTypeAndAllVersions-ObjectType-[`++roleForTypeAndAllVersions++`]]
...
* [`++zero()++`]
* [`++toRoleId(a)++`]
* [`++toComponentRoleId(objectType, index)++`]
* [`++toCustomRoleId(index)++`]
* [`++toInt(a)++`]
* [`++roleForType(objectType)++`]
* [`++roleForTypeAndVersion(objectType, majorVersion)++`]
* [`++roleForTypeAndAllVersions(objectType)++`]
* [`++gtz(a)++`]
* [`++eqz(a)++`]
* [`++toKey32(a)++`]
* [`++toKeyId(a)++`]
...
[.contract-item]
[[RoleIdLib-toRoleId-uint64-]]
==== `[.contract-item-name]#++toRoleId++#++(uint64 a) → RoleId++` [.item-kind]#public#

Converts an uint into a role id.

[.contract-item]
[[RoleIdLib-toComponentRoleId-ObjectType-uint64-]]
==== `[.contract-item-name]#++toComponentRoleId++#++(ObjectType objectType, uint64 index) → RoleId++` [.item-kind]#public#

Converts an uint into a component role id.

[.contract-item]
[[RoleIdLib-toCustomRoleId-uint64-]]
==== `[.contract-item-name]#++toCustomRoleId++#++(uint64 index) → RoleId++` [.item-kind]#public#

Converts an uint into a custom role id.
...
[.contract-item]
[[RoleIdLib-roleForType-ObjectType-]]
==== `[.contract-item-name]#++roleForType++#++(ObjectType objectType) → RoleId++` [.item-kind]#public#

Converts an uint into a role id.
Used for GIF core contracts.

[.contract-item]
[[RoleIdLib-roleForTypeAndVersion-ObjectType-VersionPart-]]
==== `[.contract-item-name]#++roleForTypeAndVersion++#++(ObjectType objectType, VersionPart majorVersion) → RoleId++` [.item-kind]#public#

Converts an uint into a RoleId.
Used for GIF core contracts.

[.contract-item]
[[RoleIdLib-roleForTypeAndAllVersions-ObjectType-]]
==== `[.contract-item-name]#++roleForTypeAndAllVersions++#++(ObjectType objectType) → RoleId++` [.item-kind]#public#
...
:MathLigMulDivOverflow: pass:normal[xref:#MathLib-MathLigMulDivOverflow--[`++MathLigMulDivOverflow++`]]
