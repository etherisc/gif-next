...
==== `[.contract-item-name]#++_initializeRegistryLinked++#++(address registryAddress)++` [.item-kind]#internal#
...
:ErrorTokenHandlerAmountIsZero: pass:normal[xref:#TokenHandler-ErrorTokenHandlerAmountIsZero--[`++ErrorTokenHandlerAmountIsZero++`]]
:ErrorTokenHandlerBalanceTooLow: pass:normal[xref:#TokenHandler-ErrorTokenHandlerBalanceTooLow-address-address-uint256-uint256-[`++ErrorTokenHandlerBalanceTooLow++`]]
:ErrorTokenHandlerAllowanceTooSmall: pass:normal[xref:#TokenHandler-ErrorTokenHandlerAllowanceTooSmall-address-address-address-uint256-uint256-[`++ErrorTokenHandlerAllowanceTooSmall++`]]
...
:ErrorTokenHandlerWalletNotAllowed: pass:normal[xref:#TokenHandler-ErrorTokenHandlerWalletNotAllowed-address-[`++ErrorTokenHandlerWalletNotAllowed++`]]
:LogTokenHandlerTokenTransfer: pass:normal[xref:#TokenHandler-LogTokenHandlerTokenTransfer-address-address-address-uint256-[`++LogTokenHandlerTokenTransfer++`]]
:constructor: pass:normal[xref:#TokenHandler-constructor-address-address-address-[`++constructor++`]]
:addAllowedWallet: pass:normal[xref:#TokenHandler-addAllowedWallet-address-[`++addAllowedWallet++`]]
:removeAllowedWallet: pass:normal[xref:#TokenHandler-removeAllowedWallet-address-[`++removeAllowedWallet++`]]
:getToken: pass:normal[xref:#TokenHandler-getToken--[`++getToken++`]]
:collectTokens: pass:normal[xref:#TokenHandler-collectTokens-address-address-Amount-[`++collectTokens++`]]
...
:_transfer: pass:normal[xref:#TokenHandler-_transfer-address-address-Amount-bool-[`++_transfer++`]]
:_checkPreconditions: pass:normal[xref:#TokenHandler-_checkPreconditions-address-Amount-[`++_checkPreconditions++`]]
:_checkIsAllowedWallet: pass:normal[xref:#TokenHandler-_checkIsAllowedWallet-address-[`++_checkIsAllowedWallet++`]]
...
.Functions
--
* [`++constructor(token, initialAuthority, initialAllowedWallet)++`]
* [`++addAllowedWallet(wallet)++`]
* [`++removeAllowedWallet(wallet)++`]
* [`++getToken()++`]
* [`++collectTokens(from, to, amount)++`]
...
.Events
--
* [`++LogTokenHandlerTokenTransfer(token, from, to, amountTransferred)++`]
...
[.contract-item]
[[TokenHandler-constructor-address-address-address-]]
==== `[.contract-item-name]#++constructor++#++(address token, address initialAuthority, address initialAllowedWallet)++` [.item-kind]#public#

[.contract-item]
[[TokenHandler-addAllowedWallet-address-]]
==== `[.contract-item-name]#++addAllowedWallet++#++(address wallet)++` [.item-kind]#external#

[.contract-item]
[[TokenHandler-removeAllowedWallet-address-]]
==== `[.contract-item-name]#++removeAllowedWallet++#++(address wallet)++` [.item-kind]#external#
...
[.contract-item]
[[TokenHandler-collectTokens-address-address-Amount-]]
==== `[.contract-item-name]#++collectTokens++#++(address from, address to, Amount amount)++` [.item-kind]#external#

collect tokens from outside of the gif and transfer them to one wallet within the scope of gif.
...
[.contract-item]
[[TokenHandler-_transfer-address-address-Amount-bool-]]
==== `[.contract-item-name]#++_transfer++#++(address from, address to, Amount amount, bool checkPreconditions)++` [.item-kind]#internal#

[.contract-item]
[[TokenHandler-_checkPreconditions-address-Amount-]]
==== `[.contract-item-name]#++_checkPreconditions++#++(address from, Amount amount)++` [.item-kind]#internal#

[.contract-item]
[[TokenHandler-_checkIsAllowedWallet-address-]]
==== `[.contract-item-name]#++_checkIsAllowedWallet++#++(address wallet)++` [.item-kind]#internal#

[.contract-item]
[[TokenHandler-LogTokenHandlerTokenTransfer-address-address-address-uint256-]]
==== `[.contract-item-name]#++LogTokenHandlerTokenTransfer++#++(address token, address from, address to, uint256 amountTransferred)++` [.item-kind]#event#
