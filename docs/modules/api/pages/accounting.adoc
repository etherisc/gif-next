...
:_changeTargetBalance: pass:normal[xref:#AccountingService-_changeTargetBalance-bool-contract-InstanceStore-NftId-ObjectType-Amount-Amount-[`++_changeTargetBalance++`]]
...
==== `[.contract-item-name]#++_changeTargetBalance++#++(bool increase, contract InstanceStore instanceStore, NftId targetNftId, ObjectType objectType, Amount amount, Amount feeAmount)++` [.item-kind]#internal#
