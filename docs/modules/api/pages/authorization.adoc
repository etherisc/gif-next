...
:LogAccessAdminRoleCreated: pass:normal[xref:#IAccessAdmin-LogAccessAdminRoleCreated-string-RoleId-enum-IAccess-RoleType-RoleId-string-[`++LogAccessAdminRoleCreated++`]]
...
:LogAccessAdminFunctionGranted: pass:normal[xref:#IAccessAdmin-LogAccessAdminFunctionGranted-string-address-string-[`++LogAccessAdminFunctionGranted++`]]
...
:ErrorAccessAdminInvalidUserOfAdminRole: pass:normal[xref:#IAccessAdmin-ErrorAccessAdminInvalidUserOfAdminRole--[`++ErrorAccessAdminInvalidUserOfAdminRole++`]]
:ErrorAccessAdminInvalidUserOfPublicRole: pass:normal[xref:#IAccessAdmin-ErrorAccessAdminInvalidUserOfPublicRole--[`++ErrorAccessAdminInvalidUserOfPublicRole++`]]
...
:getLinkedOwner: pass:normal[xref:#IAccessAdmin-getLinkedOwner--[`++getLinkedOwner++`]]
...
:roleExists: pass:normal[xref:#IAccessAdmin-roleExists-string-[`++roleExists++`]]
...
[.contract-item]
[[IAccessAdmin-getLinkedOwner--]]
==== `[.contract-item-name]#++getLinkedOwner++#++() → address linkedOwner++` [.item-kind]#external#
...
[.contract-item]
[[IAccessAdmin-roleExists-string-]]
==== `[.contract-item-name]#++roleExists++#++(string roleName) → bool exists++` [.item-kind]#external#

[.contract-item]
[[IAccessAdmin-getRoleForName-string-]]
==== `[.contract-item-name]#++getRoleForName++#++(string name) → RoleId roleId++` [.item-kind]#external#
...
[.contract-item]
[[IAccessAdmin-LogAccessAdminRoleCreated-string-RoleId-enum-IAccess-RoleType-RoleId-string-]]
==== `[.contract-item-name]#++LogAccessAdminRoleCreated++#++(string admin, RoleId roleId, enum IAccess.RoleType roleType, RoleId roleAdminId, string name)++` [.item-kind]#event#
...
[.contract-item]
[[IAccessAdmin-LogAccessAdminFunctionGranted-string-address-string-]]
==== `[.contract-item-name]#++LogAccessAdminFunctionGranted++#++(string admin, address target, string func)++` [.item-kind]#event#
...
:getLinkedOwner: pass:normal[xref:#AccessAdmin-getLinkedOwner--[`++getLinkedOwner++`]]
...
:roleExists: pass:normal[xref:#AccessAdmin-roleExists-string-[`++roleExists++`]]
...
:_toAuthorizedRoleId: pass:normal[xref:#AccessAdmin-_toAuthorizedRoleId-contract-IAuthorization-RoleId-[`++_toAuthorizedRoleId++`]]
:_authorizeTargetFunctions: pass:normal[xref:#AccessAdmin-_authorizeTargetFunctions-address-RoleId-struct-IAccess-FunctionInfo---bool-[`++_authorizeTargetFunctions++`]]
:_grantRoleAccessToFunctions: pass:normal[xref:#AccessAdmin-_grantRoleAccessToFunctions-address-RoleId-struct-IAccess-FunctionInfo---bool-[`++_grantRoleAccessToFunctions++`]]
...
:_createManagedTarget: pass:normal[xref:#AccessAdmin-_createManagedTarget-address-string-enum-IAccess-TargetType-[`++_createManagedTarget++`]]
:_createUncheckedTarget: pass:normal[xref:#AccessAdmin-_createUncheckedTarget-address-string-enum-IAccess-TargetType-[`++_createUncheckedTarget++`]]
...
:_getRoleName: pass:normal[xref:#AccessAdmin-_getRoleName-RoleId-[`++_getRoleName++`]]
...
:_checkRoleExists: pass:normal[xref:#AccessAdmin-_checkRoleExists-RoleId-bool-bool-[`++_checkRoleExists++`]]
:_checkTargetExists: pass:normal[xref:#AccessAdmin-_checkTargetExists-address-[`++_checkTargetExists++`]]
...
[.contract-item]
[[AccessAdmin-roleExists-string-]]
==== `[.contract-item-name]#++roleExists++#++(string name) → bool exists++` [.item-kind]#public#
...
==== `[.contract-item-name]#++getRoleForName++#++(string name) → RoleId roleId++` [.item-kind]#public#
...
[.contract-item]
[[AccessAdmin-_toAuthorizedRoleId-contract-IAuthorization-RoleId-]]
==== `[.contract-item-name]#++_toAuthorizedRoleId++#++(contract IAuthorization authorization, RoleId roleId) → RoleId authorizedRoleId++` [.item-kind]#internal#

[.contract-item]
[[AccessAdmin-_authorizeTargetFunctions-address-RoleId-struct-IAccess-FunctionInfo---bool-]]
==== `[.contract-item-name]#++_authorizeTargetFunctions++#++(address target, RoleId roleId, struct IAccess.FunctionInfo[] functions, bool addFunctions)++` [.item-kind]#internal#

[.contract-item]
[[AccessAdmin-_grantRoleAccessToFunctions-address-RoleId-struct-IAccess-FunctionInfo---bool-]]
==== `[.contract-item-name]#++_grantRoleAccessToFunctions++#++(address target, RoleId roleId, struct IAccess.FunctionInfo[] functions, bool addFunctions)++` [.item-kind]#internal#
...
[.contract-item]
[[AccessAdmin-_createManagedTarget-address-string-enum-IAccess-TargetType-]]
==== `[.contract-item-name]#++_createManagedTarget++#++(address target, string targetName, enum IAccess.TargetType targetType) → RoleId contractRoleId++` [.item-kind]#internal#

[.contract-item]
[[AccessAdmin-_createUncheckedTarget-address-string-enum-IAccess-TargetType-]]
==== `[.contract-item-name]#++_createUncheckedTarget++#++(address target, string targetName, enum IAccess.TargetType targetType)++` [.item-kind]#internal#
...
==== `[.contract-item-name]#++_getOrCreateTargetRoleIdAndName++#++(address target, string targetName, enum IAccess.TargetType targetType) → RoleId roleId, string roleName++` [.item-kind]#internal#
...
[.contract-item]
[[AccessAdmin-_getRoleName-RoleId-]]
==== `[.contract-item-name]#++_getRoleName++#++(RoleId roleId) → string++` [.item-kind]#internal#
...
[.contract-item]
[[AccessAdmin-_checkRoleExists-RoleId-bool-bool-]]
==== `[.contract-item-name]#++_checkRoleExists++#++(RoleId roleId, bool onlyActiveRole, bool allowAdminAndPublicRoles)++` [.item-kind]#internal#

[.contract-item]
[[AccessAdmin-_checkTargetExists-address-]]
==== `[.contract-item-name]#++_checkTargetExists++#++(address target)++` [.item-kind]#internal#
...
:constructor: pass:normal[xref:#Authorization-constructor-string-ObjectType-uint8-string-bool-bool-[`++constructor++`]]
...
.Functions
--
* [`++constructor(mainTargetName, domain, release, commitHash, isComponent, includeTokenHandler)++`]
* [`++getTokenHandlerName()++`]
* [`++getTokenHandlerTarget()++`]
...
[.contract-item]
[[Authorization-constructor-string-ObjectType-uint8-string-bool-bool-]]
==== `[.contract-item-name]#++constructor++#++(string mainTargetName, ObjectType domain, uint8 release, string commitHash, bool isComponent, bool includeTokenHandler)++` [.item-kind]#public#
...
:_addContractRole: pass:normal[xref:#ServiceAuthorization-_addContractRole-RoleId-string-[`++_addContractRole++`]]
:_addRole: pass:normal[xref:#ServiceAuthorization-_addRole-RoleId-struct-IAccess-RoleInfo-[`++_addRole++`]]
:_toRoleInfo: pass:normal[xref:#ServiceAuthorization-_toRoleInfo-RoleId-enum-IAccess-RoleType-uint32-string-[`++_toRoleInfo++`]]
...
[.contract-item]
[[ServiceAuthorization-_addContractRole-RoleId-string-]]
...
[.contract-item]
[[ServiceAuthorization-_toRoleInfo-RoleId-enum-IAccess-RoleType-uint32-string-]]
