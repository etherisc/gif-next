...
:_intialize: pass:normal[xref:#FirePool-_intialize-address-NftId-string-address-contract-IAuthorization-address-[`++_intialize++`]]
...
* [`++_intialize(registry, fireProductNftId, componentName, token, authorization, initialOwner)++`]
...
[.contract-item]
[[FirePool-_intialize-address-NftId-string-address-contract-IAuthorization-address-]]
==== `[.contract-item-name]#++_intialize++#++(address registry, NftId fireProductNftId, string componentName, address token, contract IAuthorization authorization, address initialOwner)++` [.item-kind]#internal#
