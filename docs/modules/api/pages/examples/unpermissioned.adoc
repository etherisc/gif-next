...
:createRisk: pass:normal[xref:#SimpleProduct-createRisk-bytes-[`++createRisk++`]]
...
[.contract-item]
[[SimpleProduct-createRisk-bytes-]]
==== `[.contract-item-name]#++createRisk++#++(bytes data) → RiskId++` [.item-kind]#public#
