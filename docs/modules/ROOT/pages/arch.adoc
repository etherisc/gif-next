...
image::multi-chain-setup.png[Multi-chain setup]
...
image::{imagesdir}single-chain-setup.png[Single-chain setup]
...
image::./images/instance-module.png[Instance Module]
...
image::./images/component-modules.png[Component Modules]
...
image::./images/component-diagram.png[Component Diagram]
